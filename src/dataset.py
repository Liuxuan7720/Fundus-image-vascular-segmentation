...
class SEMDataTrain(Dataset):
    ...
    def __init__(self, image_path, mask_path, in_size=256, out_size=256):
        """
        Args:
    ...
    def __getitem__(self, index):
        ...
        img_as_np=np.power(img_as_np/255.0,0.833)
        img_as_np=np.uint8(img_as_np*255.0)
        '''
...
class SEMDataVal(Dataset):
    ...
    def __getitem__(self, index):
        ...
        img_as_np = np.pad(img_as_np, ((4, 4), (5, 6)), "constant")
